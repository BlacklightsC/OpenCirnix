...
namespace Cirnix.Memory
{
    public static class Join
    {
        ...
        public static void RoomJoin(string roomname)
        {
            ...
            //VirtualEx.Invoke(type, new object[] { Warcraft3Info.Handle, intPtr, (UIntPtr)((ulong)((long)array2.Length)), 64U, 0U });
            //ReadProc.Invoke(type, new object[] { Warcraft3Info.Handle, intPtr, array2, array2.Length, 0 });    
            ...
            // WriteProc.Invoke(type, new object[] { Warcraft3Info.Handle, intPtr, bytes, bytes.Length + 1, 0 });
