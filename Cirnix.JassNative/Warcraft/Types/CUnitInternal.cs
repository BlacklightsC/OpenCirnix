...
namespace Cirnix.JassNative.WarAPI.Types
{
  ...
  {
    public unsafe CUnitInternal.VTable* Virtual;
    ...
    //{
    //  return FastCall.Invoke<CUnit>(GameAddresses.GetUnitFromHandle, (object) handle).AsUnsafe();
    //}
    ...
    //{
    //  return ThisCall.Invoke<CAbilityPtr>(GameAddresses.CUnit__GetAbility, (object) ability, (object) false, (object) true, (object) true, (object) true).AsUnsafe();
    //}
    ...
    //    IntPtr num2;
    //    if (num1 != -1 && (num2 = GameFunctions.sub_6F4786B0(a1)) != IntPtr.Zero)
    //    {
    //      do
    //      {
    //        cabilityPtrList.Add(((CAbility*) (void*) num2)->AsSafe());
    //        num2 = (*(int*) (void*) (num2 + 36) & *(int*) (void*) (num2 + 40)) == -1 ? IntPtr.Zero : GameFunctions.sub_6F4786B0((int*) (void*) (num2 + 36));
    //      }
