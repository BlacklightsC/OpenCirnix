...
namespace Cirnix.JassNative.WarAPI.Types
{
    ...
    public struct CGameUI
    {
        ...
        public int IsUserInterfaceEnabledField;
        ...
        public unsafe CSimpleMessageFrame* Message;
        public unsafe CSimpleMessageFrame* UnitMessage;
        public unsafe CSimpleMessageFrame* ChatMessage;
        public unsafe CSimpleMessageFrame* TopMessage;
        ...
        public bool IsUserInterfaceEnabled {
            get {
                return IsUserInterfaceEnabledField == 0;
            }
            set {
                IsUserInterfaceEnabledField = value ? 1 : 0;
            }
        }

        public unsafe void WriteChatMessage(int sender, string message, ChatRecipients recipients, float duration)
        {
            fixed (CGameUI* @this = &this)
