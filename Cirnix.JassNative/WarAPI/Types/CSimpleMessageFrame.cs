...
namespace Cirnix.JassNative.WarAPI.Types
{
    ...
    public struct CSimpleMessageFrame
    {
        ...
        public unsafe void Method26()
        {
            ...
            {
                IntPtr num = Methods->Method26(@this);
            }
        }
        ...
        public unsafe void WriteLine(string message, Color* color, float duration)
        {
            fixed (CSimpleMessageFrame* @this = &this)
            {
                IntPtr num = Methods->WriteLine(@this, message, color, duration);
            }
        }

        public unsafe void WriteLine(string message, Color color, float duration)
        {
            WriteLine(message, &color, duration);
        }
        ...
        public struct VTable
        {
            ...
            public Method26Prototype Method26 =>  (Method26Prototype)Marshal.GetDelegateForFunctionPointer(Method26Ptr, typeof(Method26Prototype));

            public WriteLinePrototype WriteLine => (WriteLinePrototype)Marshal.GetDelegateForFunctionPointer(WriteLinePtr, typeof(WriteLinePrototype));
